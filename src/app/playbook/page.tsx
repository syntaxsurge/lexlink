  ...
  return (
    <main className='prose prose-neutral dark:prose-invert max-w-3xl px-6 py-12'>
      ...
      <ul>
        ...
        <li>
          ICP: Motoko canister derives P2WPKH tBTC addresses, verifies UTXOs,
          emits attestations
        </li>
      ...
      <ol>
        <li>
          Register IP → SPG mints NFT + registers IP + attaches license terms
        </li>
        <li>
          Create license order → ICP canister returns a tBTC deposit address
        </li>
...
dfx canister id btc_escrow --playground`}
      ...
      <ul>
        <li>
          <a href='https://docs.story.foundation' target='_blank'>
            Story Protocol Docs
          </a>
        </li>
        <li>
        ...
        <li>
          <a href='https://docs.constellationnetwork.io' target='_blank'>
            Constellation Docs
          </a>
        </li>
      </ul>
