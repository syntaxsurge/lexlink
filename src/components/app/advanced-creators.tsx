...
export function AdvancedCreators({
  ...
  return (
    <div className={cn('space-y-3', className)}>
      ...
      {fields.length === 0 ? (
        <p className='rounded-md border border-dashed border-border/60 bg-card/40 px-3 py-2 text-xs text-muted-foreground'>
          Leave this section blank to keep the default AI Studio creator, or add
          contributors to override the split.
        </p>
      ) : (
              ...
              >
                ...
                <div className='space-y-1 md:col-span-3'>
                  ...
                  <Input
                    ...
                    {...register(
                      `${fieldName}.${index}.socialPlatform` as const
                    )}
                  />
