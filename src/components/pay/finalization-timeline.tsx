                ...
                <div
                  className={`relative z-10 flex h-14 w-14 items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-300 group-hover:scale-110 ${
                    step.status === 'complete'
                      ...
                      : step.status === 'current'
                        ? 'animate-pulse border-primary/50 bg-gradient-to-br from-primary to-primary/80 shadow-primary/20'
                        : step.status === 'failed'
                        ...
                        <Badge
                          ...
                          className={`px-3 py-1 text-xs font-bold uppercase tracking-wide ${
                            step.status === 'complete'
                              ...
                              : step.status === 'current'
                                ? 'border-primary/60 bg-primary text-white shadow-lg shadow-primary/20'
                                : step.status === 'failed'
